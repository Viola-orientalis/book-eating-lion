...
import com.bookeatinglion.api.service.AdminStatsQueryService;
...
public class AdminStatsController {
    ...
    public ResponseEntity<AdminStatsDto.SummaryResponse> getSummaryStats() {
        return ResponseEntity.ok(adminStatsQueryService.getSummaryStats());
    }
    ...
    public ResponseEntity<List<AdminStatsDto.DemographicPreferenceDto>> getDemographicPreferences() {
        return ResponseEntity.ok(adminStatsQueryService.getDemographicPreferences());
    }
    ...
    public ResponseEntity<List<AdminStatsDto.SalesTrendDto>> getSalesTrend() {
        return ResponseEntity.ok(adminStatsQueryService.getSalesTrend());
    }
}
