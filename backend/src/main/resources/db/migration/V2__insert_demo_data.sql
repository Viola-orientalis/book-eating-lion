-- V2__insert_demo_data.sql: Insert Demo Users, Admin & Books

INSERT IGNORE INTO Members (username, password, name, gender, age, role) VALUES 
...
('admin', '$2a$10$fHX4VHdsN2kPrh0GJgNjjeIb.FZJ6ApJZf5UFoUZaO.D8j3y2CqXK', '관리자', 'MALE', 30, 'ADMIN');

INSERT IGNORE INTO Books (title, author, publisher, isbn, price, stock, category, description, image_url, sale_status) VALUES
('방구석 미술관', '조원재', '블랙피쉬', '9791165961084', 17500, 20, '미술', '어렵게만 느껴지던 명화를 편안한 입담으로 풀어내는 미술 교양서.', 'https://team3-bookeatinglion-storage-s3.s3.ap-northeast-2.amazonaws.com/books/art_01.png', 'ON_SALE'),
...
('삶의 격', '피터 비에리', '은행나무', '9788956608567', 16000, 15, '에세이', '존엄성을 다해 살아간다는 것에 대한 깊은 성찰.', 'https://team3-bookeatinglion-storage-s3.s3.ap-northeast-2.amazonaws.com/books/essay_02.png', 'ON_SALE'),
...
('소크라테스의 변명', '플라톤', '돋을새김', '9788970440521', 10000, 30, '인문', '진리와 서양 철학의 뿌리를 찾는 고전 명작.', 'https://team3-bookeatinglion-storage-s3.s3.ap-northeast-2.amazonaws.com/books/humanity_03.png', 'ON_SALE'),
('생각에 관한 생각', '다니엘 카네만', '김영사', '9788934972648', 22000, 10, '인문', '노벨상 수상자가 밝혀내는 인간 심리와 직관의 실체.', 'https://team3-bookeatinglion-storage-s3.s3.ap-northeast-2.amazonaws.com/books/humanity_04.png', 'ON_SALE'),
...
('원씽', '게리 켈러', '비즈니스북스', '9788901159980', 14000, 25, '자기계발', '복잡한 세상을 이기는 단 하나의 원칙.', 'https://team3-bookeatinglion-storage-s3.s3.ap-northeast-2.amazonaws.com/books/self_02.png', 'ON_SALE'),
...
INSERT IGNORE INTO Cart_Items (member_id, book_id, quantity) VALUES
(1, 1, 2),
(1, 2, 1);
